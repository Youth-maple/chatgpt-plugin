...
import { SendEmoticonTool } from '../utils/tools/SendEmoticonTool.js'
import { SendLocalImageTool } from '../utils/tools/SendLocalImageTool.js'
  ...
  async bym (e) {
    ...
    if (prop < Config.bymRate) {
      ...
      const tools = [
        ...
        new SendEmoticonTool(),
        new SendLocalImageTool()
